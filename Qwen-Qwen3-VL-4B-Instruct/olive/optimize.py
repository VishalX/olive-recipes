...
def update_genai_config(output_dir: str = "models", device: str = "gpu"):
    ...
    # Qwen3-VL processor: patch_size 16, merge_size 2, temporal_patch_size 2
    processor_config = {
        "processor": {
...
def optimize(device: str = "gpu"):
    ...
    # update_genai_config(output_dir="models", device=device)


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Optimize Qwen3-VL-4B model with Olive")
    parser.add_argument(
        "--device",
        type=str,
        choices=["gpu", "cpu"],
